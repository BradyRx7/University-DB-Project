...
public class TestClassCreation {
    ...
    public static void main(String[] args) {
        ...
        // Create a classroom 
        Classroom classroom = new Classroom("PA100", IClassroom.Room.CLASSROOM);
        ...
        studentCourse.getCourseGrade().add(90.5);
        studentCourse.getCourseGrade().add(100.0);
        studentCourse.getCourseGrade().add(70.5);
        studentCourse.getCourseGrade().add(65.0);

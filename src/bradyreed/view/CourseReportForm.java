...
public class CourseReportForm extends javax.swing.JFrame {
     ...
     */
    public CourseReportForm(OfferedCourseDataModel offeredCourseDataModelArg) {

        initComponents();
        this.setSize(400, 320);

        this.offeredCourseDataModel = offeredCourseDataModelArg;
        courseListArea.setText(offeredCourseDataModel.getListOfOfferedCourses().toString());
    ...
    public static void main(String args[]) {
        ...
        OfferedCourse testCourse = new OfferedCourse("123", "Biology", testRoom);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CourseReportForm(offeredCoursesDataModel22).setVisible(true);
            }
        });
    }
